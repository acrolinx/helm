Acrolinx Platform 2022.09.1 Helm Chart
===========================================================

This Helm chart installs version 2022.09.1 of the Acrolinx Platform and version 1.3.7 of the Acrolinx Core Platform operator in a single-node Kubernetes cluster.
...
See the [release notes][acrolinx-release-notes] for what's new in 2022.09.1.
...
Helm charts can be distributed as plain archives, such as `acrolinx-platform-1.3.7+2022.09.1.tgz`, or via a [Helm repository][helm-repos].
