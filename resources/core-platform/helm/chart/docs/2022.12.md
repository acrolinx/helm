...
This Helm chart installs version 2022.12 of the Acrolinx Platform and version 1.3.12 of the Acrolinx Core Platform operator in a single-node Kubernetes cluster.
...
Helm charts can be distributed as plain archives, such as `acrolinx-platform-1.3.12+2022.12.tgz`, or via a [Helm repository][helm-repos].
