...
This Helm chart installs version 2023.06 of the Acrolinx Platform and version 1.4.3 of the Acrolinx Core Platform operator in a single-node Kubernetes cluster.
...
Helm charts can be distributed as plain archives, such as `acrolinx-platform-1.4.3+2023.06.tgz`, or via a [Helm repository][helm-repos].
