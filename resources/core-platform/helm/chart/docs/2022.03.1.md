...
This Helm chart installs version 2022.03.1 of the Acrolinx Platform and version 1.2.21 of the Acrolinx Core Platform operator in a single-node Kubernetes cluster.
...
Helm charts can be distributed as plain archives, such as `acrolinx-platform-1.2.21+2022.03.1.tgz`, or via a [Helm repository][helm-repos].
