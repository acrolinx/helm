Acrolinx Platform 2021.09 Helm Chart
===========================================================

This Helm chart installs version 2021.09 of the Acrolinx Platform and version 1.2.2 of the Acrolinx Acrolinx Core Platform operator in a single-node Kubernetes cluster.
...
See the [release notes][acrolinx-release-notes] for what's new in 2021.09.
...
Helm charts can be distributed as plain archives, such as `acrolinx-platform-1.2.2+2021.09.tgz`, or via a [Helm repository][helm-repos].
...
[acrolinx-docs-jreport-db-settings]: https://docs.acrolinx.com/coreplatform/2021.09/en/acrolinx-standard-stack-only/external-databases/connect-to-an-external-analytics-database
[acrolinx-docs-reporting-db-settings]: https://docs.acrolinx.com/coreplatform/2021.09/en/acrolinx-standard-stack-only/external-databases/connect-to-an-external-reporting-database
...
[acrolinx-docs-term-db-settings]: https://docs.acrolinx.com/coreplatform/2021.09/en/acrolinx-standard-stack-only/external-databases/connect-to-an-external-terminology-database
...
[acrolinx-release-notes]: https://docs.acrolinx.com/coreplatform/2021.09/en/acrolinx-core-platform-releases/acrolinx-release-notes-including-subsequent-service-releases
