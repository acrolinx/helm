...
This Helm chart installs the Acrolinx Platform 2021.03 and the Acrolinx Core Platform Operator 0.8.17 in a single node Kubernetes cluster.
...
Helm charts can be distributed as plain archives, such as `acrolinx-platform-0.8.17+2021.03.tgz`, or via a [Helm repository][helm-repos].
